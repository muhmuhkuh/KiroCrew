...
def _proc_subtree_sample(pid: int | None) -> platform_compat.SubtreeSample:
...
def _attributed_count(total: int | None, sharers: int, previous: int | None) -> int | None:
...
def _macos_vm_reclaimable_pages() -> int | None:
