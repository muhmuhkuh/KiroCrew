...
• This is a standalone investigation session, not an Issue Radar crew session. Do NOT call \`issue_radar_crew_read\` or \`issue_radar_crew_record\`; those tools require a crew-owned session and will fail here.
