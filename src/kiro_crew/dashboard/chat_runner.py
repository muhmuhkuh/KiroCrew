...
from kiro_crew.acp_backends import ACP_BACKEND_PI, ACP_BACKENDS_COMPACT
...
async def _run_chat(
    ...
    *,
    ...
    try:
        ...
        try:
            client.child_fidelity_aware = True
        ...
        if is_slash:
            ...
            # default behavior).
            from kiro_crew.context import (
                window_for_provider_client,  # circular: context -> chat
            )
        ...
        try:
            client.child_fidelity_aware = False
        except Exception:
            pass
