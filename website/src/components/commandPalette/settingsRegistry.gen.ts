...
export const SETTINGS_REGISTRY: SettingEntry[] = [
  ...
  },
  {
    ...
    labelSuffix: "Webex",
    description:
      "Webex account emails permitted to DM the bot. Empty = nobody (fail closed) — anyone in an org can message a Webex bot, so add only your own.",
    tab: "channels",
    type: "input",
    occurrence: 1,
    params: {
  ...
  },
  {
    ...
    labelSuffix: "Slack",
    description:
      "Enterprise Grid org IDs to allow (starts with E or T). Leave empty to allow all orgs.",
    tab: "channels",
    type: "input",
    occurrence: 1,
    params: {
  ...
  },
  {
    ...
    description:
      "Phone numbers or Apple Account emails allowed to message the agent. Empty denies everyone — anyone who knows this Mac's handle can send to it, so there is no safe default. Formatting is ignored.",
    tab: "channels",
    type: "input",
    occurrence: 1,
    params: {
  ...
  },
  {
    ...
    description:
      "Phone numbers (digits with country code, no plus sign) that may also chat with the agent. Empty adds nobody beyond you.",
    tab: "channels",
    type: "input",
    occurrence: 1,
    params: {
  ...
  },
  {
    ...
    labelSuffix: "Webex",
    description:
      'Empty means no space is answered, so turning the switch on alone grants nothing. The sender must also be on the allowed-emails list. A space ID is an opaque string — list yours with:\ncurl -H "Authorization: Bearer $WEBEX_BOT_TOKEN" https://webexapis.com/v1/rooms',
    tab: "channels",
    type: "input",
    occurrence: 1,
    params: {
  ...
  },
  {
    ...
    labelSuffix: "Teams",
    description:
      "Azure AD UPNs/emails OR object ids permitted to DM the bot. Teams activities reliably carry the object id (email is often absent), so object ids work out of the box. Empty = nobody (fail closed).",
    tab: "channels",
    type: "input",
    occurrence: 1,
    params: {
  ...
  },
  {
    ...
    labelSuffix: "Webex",
    description:
      "Off by default. A reply in a space is visible to everyone in it, including people not on the allowed-emails list.",
    tab: "channels",
    type: "toggle",
    occurrence: 1,
    params: {
  ...
  },
  {
    ...
    labelSuffix: "Teams",
    description:
      "Azure Bot client secret. Stored only in .env (never config.json).",
    tab: "channels",
    type: "input",
    occurrence: 1,
    params: {
  ...
  },
  {
    ...
    labelSuffix: "Teams",
    description:
      "Start the channel at gateway boot when the App ID + password are set.",
    tab: "channels",
    type: "toggle",
    occurrence: 1,
    params: {
  ...
  },
  {
    ...
    labelSuffix: "Discord",
    description:
      "Created for you when you save these settings, if it does not exist yet.",
    tab: "channels",
    type: "input",
    occurrence: 1,
    params: {
  ...
  },
  {
    ...
    labelSuffix: "WeChat",
    description:
      "Created for you when you turn this on, if it does not exist yet.",
    tab: "channels",
    type: "input",
    occurrence: 1,
    params: {
  ...
  },
  {
    ...
    labelSuffix: "WhatsApp",
    description:
      "Created for you when you turn this on, if it does not already exist.",
    tab: "channels",
    type: "input",
    occurrence: 1,
    params: {
  ...
  },
  {
    ...
    labelSuffix: "Teams",
    description:
      "Compact automatically at this percentage, even without a reply, so the context window never overflows.",
    tab: "channels",
    type: "input",
    occurrence: 1,
    params: {
  ...
  },
  {
    ...
    labelSuffix: "Webex",
    description:
      "Compact automatically at this point, even without a decision, so the context window never overflows.",
    tab: "channels",
    type: "input",
    occurrence: 1,
    params: {
  ...
  },
  {
    ...
    labelSuffix: "iMessage",
    description:
      "Override where the Messages database is read from. Leave empty to use the default location.",
    tab: "channels",
    type: "input",
    occurrence: 1,
    params: {
  ...
  },
  {
    ...
    labelSuffix: "Slack",
    description:
      "The one member who can always interact with the bot (KIROCREW_OWNER_ID). Starts with U or W.",
    tab: "channels",
    type: "input",
    occurrence: 1,
    params: {
  ...
  },
  {
    ...
    labelSuffix: "Slack",
    description:
      "Show phase-aware emoji reactions (queued → thinking → coding → done) on messages.",
    tab: "channels",
    type: "toggle",
    occurrence: 1,
    params: {
  ...
  },
  {
    ...
    labelSuffix: "Webex",
    description:
      "Reply under the message's own thread when it has one, which keeps a busy space readable.",
    tab: "channels",
    type: "toggle",
    occurrence: 1,
    params: {
  ...
  },
  {
    ...
    labelSuffix: "iMessage",
    description:
      "Which service outbound replies use. Inbound is unaffected — messages are accepted whichever service they arrive over.",
    tab: "channels",
    type: "select",
    occurrence: 1,
    params: {
  ...
  },
  {
    ...
    labelSuffix: "Slack",
    description:
      "Post the model's reasoning as a thread reply. Disable to keep responses concise.",
    tab: "channels",
    type: "toggle",
    occurrence: 1,
    params: {
  ...
  },
  {
    ...
    labelSuffix: "Slack",
    description:
      "App-level token required for Socket Mode (starts with xapp-).",
    tab: "channels",
    type: "input",
    occurrence: 1,
    params: {
  ...
  },
  {
    ...
    labelSuffix: "Slack",
    description:
      "From OAuth & Permissions after installing your Slack app (starts with xoxb-).",
    tab: "channels",
    type: "input",
    occurrence: 1,
    params: {
  ...
  },
  {
    ...
    labelSuffix: "Slack",
    description:
      "Trigger word for the Slack slash command (without the leading /).",
    tab: "channels",
    type: "input",
    occurrence: 1,
    params: {
  ...
  },
  {
    ...
    labelSuffix: "Webex",
    description:
      "When a conversation's context passes this, suggest /compact or /new instead of compacting automatically.",
    tab: "channels",
    type: "input",
    occurrence: 1,
    params: {
  ...
  },
  {
    ...
    description:
      "Keep the most recent turn visible as a sticky banner once it scrolls above the fold.",
    tab: "chat",
    type: "toggle",
    occurrence: 1,
  },
  {
    ...
    description:
      "Render diffs as plain unified-diff text instead of syntax-highlighted colour. Uses less memory on large diffs.",
    tab: "chat",
    type: "toggle",
    occurrence: 1,
  },
  ...
  },
  {
    ...
    description:
      "Also capture the target window and pass its file path. The accessibility tree stays the primary channel; windows containing a password field are never captured.",
    tab: "computer-use",
    type: "toggle",
    occurrence: 1,
  },
  {
    ...
    description:
      "Let the agent read desktop app windows through accessibility and act on their controls. Off until you turn it on here — an agent cannot enable it.",
    tab: "computer-use",
    type: "toggle",
    occurrence: 1,
  },
  {
    ...
    description:
      "How many controls one window reading returns. A window with more than this gets truncated, and the agent is told so. Raise it for dense apps (a spreadsheet, an IDE); lower it to spend fewer tokens per reading.",
    tab: "computer-use",
    type: "input",
    occurrence: 1,
  },
  {
    ...
    description:
      "Longest edge of the screenshot, in pixels. Smaller is cheaper and faster to read; larger keeps small text legible if the agent has to fall back to the image.",
    tab: "computer-use",
    type: "input",
    occurrence: 1,
  },
  {
    ...
    description:
      "Draw a cursor that glides to each target and pulses when it clicks, so you can follow along on screen. Purely visual — it changes nothing about what the agent is allowed to do, and it only appears for clicks that move the real pointer.",
    tab: "computer-use",
    type: "toggle",
    occurrence: 1,
  },
  ...
  },
  {
    ...
    description:
      "The Crew Members page and Crew Mode chats. Both are still being built, so neither is offered until you turn this on.",
    tab: "developer",
    type: "toggle",
    occurrence: 1,
  },
  {
    ...
    description:
      "Show Developer page in sidebar with Logs, System metrics, and Memory internals",
    tab: "developer",
    type: "toggle",
    occurrence: 1,
  },
  {
    ...
    description:
      "Start a gateway on this machine. Turn it off to use Kiro Crew as a client only, connecting to the gateway you have configured instead of running one here. Takes effect next time you open the app.",
    tab: "developer",
    type: "toggle",
    occurrence: 1,
  },
  {
    ...
    description:
      "Inbound webhook tokens, registered contexts, and run history. The API works; the page is not finished.",
    tab: "developer",
    type: "toggle",
    occurrence: 1,
  },
  ...
  },
  {
    ...
    description:
      "Shell the built-in terminal launches — an absolute path or a command on PATH. Leave empty to use the system default ($SHELL).",
    tab: "display",
    type: "input",
    occurrence: 1,
  ...
  },
  {
    ...
    description:
      "Font for the built-in terminal. Pick one installed on the machine you view the dashboard from, or type any font name — a Nerd Font renders Powerline and prompt-theme glyphs.",
    tab: "display",
    type: "select",
    occurrence: 1,
  },
  {
    ...
    description:
      "UI font family for the dashboard. Code font follows the active theme, except OpenDyslexic which supplies its own.",
    tab: "display",
    type: "buttonGroup",
    occurrence: 1,
  },
  ...
  },
  {
    ...
    description:
      "Highlight the N most-recently-active sessions with a graded accent stripe (0 = off). Saved to your Kiro Crew config.",
    tab: "display",
    type: "stepper",
    occurrence: 1,
  },
  ...
  },
  {
    ...
    description:
      "When on, opening the web app connects every crew automatically, and reconnects them when you come back to the tab. Turn off to connect a crew only when you switch to it.",
    tab: "instances",
    type: "toggle",
    occurrence: 1,
  },
  ...
  },
  {
    ...
    labelKey:
      "pages.settings.notificationsPanel.play_sound_on_new_notifications",
    tab: "notifications",
    type: "toggle",
    occurrence: 1,
  },
  ...
  },
  {
    ...
    label: "Sources",
    description:
      "Mute notification sources or override their priority. Muted notifications stay in history but never badge, sound, or banner.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Off by default. When on, every third-party app you install can run its own code straight away, without asking you first.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Add your own deny patterns (Python-compatible regex). These are enforced at {{productName}}'s PreToolUse gate alongside the built-in rules.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Bind chat-tab switching to Ctrl+digit instead of Option+digit",
    tab: "shortcuts",
    type: "toggle",
    occurrence: 1,
  },
  {
    ...
    description:
      "Analyze each completed session and draft a reusable SKILL.md when the session demonstrates a recurring procedure — one a future session, working on a different target, would run again. Off by default. Drafts are staged to the pending queue on the Skills tab for review — nothing goes live without your approval (see below).",
    tab: "skills",
    type: "toggle",
    occurrence: 1,
  ...
  },
  {
    ...
    labelKey:
      "pages.settings.skillsPanel.require_approval_before_generated_skills_go_live",
    description:
      "Keep every auto-generated candidate in the pending queue until you approve it. Turning this off lets prose-only skills publish automatically; skills that bundle scripts always require approval regardless.",
    tab: "skills",
    type: "toggle",
    occurrence: 1,
  ...
  },
  {
    ...
    description:
      "Use a fast model to detect when you've finished a complete request and send it automatically. Streaming providers only.",
    tab: "voice",
    type: "toggle",
    occurrence: 1,
  ...
  },
  {
    ...
    description:
      "AWS credentials profile for Transcribe (blank = default chain)",
    tab: "voice",
    type: "input",
    occurrence: 1,
  },
  ...
  },
  {
    ...
    description:
      "Show an animated panel while recording instead of the thin status bar. Falls back to the bar when the browser lacks WebGL2 or your system requests reduced motion.",
    tab: "voice",
    type: "toggle",
    occurrence: 1,
  },
  ...
  },
  {
    ...
    description:
      "How often the transcript is redrawn while you speak. Lower feels more immediate and costs more processing.",
    tab: "voice",
    type: "stepper",
    occurrence: 1,
  ...
  },
  {
    ...
    description:
      "Models download on demand. Select one and click Download now; the desktop app already includes every other runtime dependency.",
    tab: "voice",
    type: "select",
    occurrence: 1,
    configKey: "stt.model",
  },
  {
    ...
    description:
      "How much silence commits what you just said. Lower reacts sooner; higher tolerates thinking pauses.",
    tab: "voice",
    type: "stepper",
    occurrence: 1,
  ...
  },
  {
    ...
    description:
      "Path to the piper executable. Leave blank to auto-detect on PATH or in a ~/piper-venv install",
    tab: "voice",
    type: "input",
    occurrence: 1,
  },
  {
    ...
    description:
      "Path to the Piper voice model (.onnx). Required — download from huggingface.co/rhasspy/piper-voices",
    tab: "voice",
    type: "input",
    occurrence: 1,
  },
  {
    ...
    description:
      "Local speech recognition runs on this machine and sends nothing anywhere. Transcribe uploads your audio to AWS.",
    tab: "voice",
    type: "select",
    occurrence: 1,
  ...
  },
  {
    ...
    description:
      "The built-in engine needs no setup; Piper is offline with better quality; Amazon Polly uses AWS credentials + network",
    tab: "voice",
    type: "select",
    occurrence: 2,
  ...
  },
  {
    ...
    description:
      "Show the transcript in the input box as you speak, instead of only when you stop.",
    tab: "voice",
    type: "toggle",
    occurrence: 1,
  ...
  },
  {
    ...
    description:
      "Only used by “Both”. Hold the key longer than this to talk; a quicker tap starts recording and leaves it on.",
    tab: "voice",
    type: "stepper",
    occurrence: 1,
  },
