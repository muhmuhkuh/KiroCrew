      ...
      <div className="flex items-center gap-2 mb-3 flex-wrap">
        <div className="relative flex-1 min-w-[180px]">
          ...
          <input
            ...
            className="w-full pl-8 pr-2 py-1.5 text-[13px] rounded-md border border-border bg-bg text-text placeholder:text-muted outline-hidden focus-visible:border-accent"
          />
        </div>
